...
type CommonFlags struct {
	...
	IdpProvider           string `help:"The configured IDP provider" env:"SAML2AWS_IDP_PROVIDER" enum:"Akamai,AzureAD,ADFS,ADFS2,Browser,Ping,JumpCloud,Okta,OneLogin,PSU,KeyCloak," optional:"" default=""`
	...
	KCBroker              string `help:"The Keycloak Broker"`
}
...
type LoginExecFlags struct {
	...
	TryNoPrompt       bool   `help:"Try to avoid prompting for input where possible" optional:""`
}
